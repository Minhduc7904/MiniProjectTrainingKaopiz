...
description: "Ingest / Research phase: gather sources and lock scope; do not create PLAN.md in this step."
---

> DevKit agent command `devkit-research`, published as a skill because Codex has no repo-level slash commands.
