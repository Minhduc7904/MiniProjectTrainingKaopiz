---
name: kz-analyze-bug
description: "UC10 bug analysis via @analyze-bug: required BUG-ID, optional SOURCE jira|manual only."
---

> DevKit agent command `kz-analyze-bug`, published as a skill because Codex has no repo-level slash commands.
...
Sync → **`.agents/commands/kz-analyze-bug.md`**
