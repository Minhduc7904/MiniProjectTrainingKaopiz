...
| `StudentLearningEndpointsComponentTests` | GET list enrollment/catalog với Student actor và GET progress với Admin actor. | List trả `200`, offset envelope, thumbnail, `no-store`; catalog chỉ có Course available; Admin bị `403 FORBIDDEN`. |
