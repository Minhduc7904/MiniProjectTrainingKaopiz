...
1. Đọc toàn bộ `skills/test-integration/reference.md`.
2. Đọc toàn bộ `skills/test-integration/template.md`.
...
chuyển về `skills/test-unit` hoặc `skills/test-component`.
