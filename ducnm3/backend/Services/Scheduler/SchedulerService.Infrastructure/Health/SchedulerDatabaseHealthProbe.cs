...
namespace SchedulerService.Infrastructure.Health;

public sealed partial class SchedulerDatabaseHealthProbe(
    string connectionString,
    ILogger<SchedulerDatabaseHealthProbe> logger) : IDatabaseHealthProbe
{
    ...
    {
        [LoggerMessage(EventId = 2001, Level = LogLevel.Warning, Message = "Scheduler database health probe failed.")]
