---
name: devkit-workflow-profile-greenfield
description: "Greenfield: MCP stub + interview by section, audit, finalize devkit.workflow-profile.json without deep repo archaeology."
---

> DevKit agent command `devkit-workflow-profile-greenfield`, published as a skill because Codex has no repo-level slash commands.
