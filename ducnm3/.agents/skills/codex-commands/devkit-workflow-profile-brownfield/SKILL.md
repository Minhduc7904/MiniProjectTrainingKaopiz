---
name: devkit-workflow-profile-brownfield
description: "Brownfield: MCP heuristics, repo investigation, interview, audit answer_sources, finalize workflow profile."
---

> DevKit agent command `devkit-workflow-profile-brownfield`, published as a skill because Codex has no repo-level slash commands.
