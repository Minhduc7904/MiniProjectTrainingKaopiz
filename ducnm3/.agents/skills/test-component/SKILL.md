...
1. Đọc toàn bộ `.agents/skills/test-component/reference.md`.
2. Đọc toàn bộ `.agents/skills/test-component/template.md`.
...
`.agents/skills/test-unit`. Nếu cần xác minh SQL migration, repository, MinIO, RabbitMQ
hoặc adapter với resource thật, dùng `.agents/skills/test-integration`.
