// File: backend/Services/Media/MediaService.Api/Endpoints/MediaUsages/GetUrl/GetMediaUsageUrlEndpoint.cs
// Mục đích: Khai báo Minimal API endpoint GetMediaUsageUrlEndpoint, chuyển HTTP request thành use case và map response.
