    ...
    TimeProvider timeProvider) : IMediaDerivationRepository
{
    ...
    private static ThumbnailDerivationWork MapWork(MediaDerivationJob job) =>
        new(
            job.Id,
            job.SourceMediaId,
            new StorageObjectLocation(
                job.SourceMedia.Bucket,
                job.SourceMedia.ObjectKey),
            job.SourceMedia.MediaType,
            job.SourceMedia.ContentType,
            job.SourceMedia.Status,
            job.DerivativeMediaId,
            new StorageObjectLocation(
                job.DerivativeMedia.Bucket,
                job.DerivativeMedia.ObjectKey),
            job.DerivativeMedia.Status,
            job.Status,
            new ActorReference(
                job.SourceMedia.UploadedByType,
                job.SourceMedia.UploadedBy));
